<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2024 <a href="">Groupe Abbatiello</a>.</strong> All rights reserved.
      </footer>
    </div><!-- ./wrapper -->
    ...
    <script src="<?= base_url('assets/adminlte/dist/js/pages/dashboard.js')?>" type="text/javascript"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<?= base_url('assets/adminlte/dist/js/demo.js')?>" type="text/javascript"></script>
  </body>
</html>