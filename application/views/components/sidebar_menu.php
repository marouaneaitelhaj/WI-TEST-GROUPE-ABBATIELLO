...
<ul class="sidebar-menu">
  ...
  <li class="active treeview">
    ...
    <ul class="treeview-menu">
      <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i> Afficher tous les utilisateurs</a></li>
      <li><a href="index2.html"><i class="fa fa-circle-o"></i> Ajouter un nouvel utilisateur</a></li>
    </ul>
  </li>
  <li class="active treeview">
    <a href="#">
